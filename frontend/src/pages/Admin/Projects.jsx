...
//          {loading ? (
//           <Shimmer /> // Show Shimmer component while loading
//         ) : (
...
import { Button } from "@/components/ui/button";
import axios from "axios";
import Shimmer from '@/components/AdminComponents/LoadingComponents/project/Shimmer'; // Import the Shimmer component
    ...
    <div>
      ...
      <div className="flex flex-wrap justify-between ">
        {loading ? (
          ...
          currentItems.map((item) => (
            <div key={item.id} className="w-1/2 px-5 py-5">
              <Card className="h-60">
                <CardHeader>
                  <CardTitle className="flex justify-between items-center">
                    {item.Project.name}
                ...
                <CardContent className="text-sm flex flex-col justify-between flex-grow">
                  <div>
                    <p>{item.Project.description}</p>
                  </div>
                </CardContent>
                <CardFooter className="mt-auto">
                  <div>
                    <Button
                      onClick={() => window.open(item.Project.git_repository_link, '_blank')}
                    >
                      Go to GitHub
                    </Button>
                  </div>
